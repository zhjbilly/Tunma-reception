...
async function transform(source, map) {
	...
	const res = await plugin.transform.call(Object.assign({}, this._compilation && require_context$1.createBuildContext$1(this._compiler, this._compilation, this), context), source, id);
